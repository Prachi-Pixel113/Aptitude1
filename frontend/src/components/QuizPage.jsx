      ...
      <div style={{ minHeight: '100vh', background: 'var(--bg-page)' }}>
        ...
        <div className="quiz-container">
          ...
          <div style={{ 
            ...
            <h2 className="heading-3" style={{ margin: 0 }}>Question Summary</h2>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              <span className="body-small" style={{ color: 'var(--text-secondary)' }}>Time Left:</span>
              <span className="body-medium" style={{ 
                fontWeight: '600', 
                color: timeLeft < 300 ? '#dc2626' : 'var(--accent-text)',
                fontSize: '1.125rem'
              }}>
                {formatTime(timeLeft)}
              </span>
              ...
              <div style={{ 
                ...
                <svg width="200" height="200" style={{ position: 'absolute' }}>
                  ...
                  <circle
                    ...
                    stroke="#22c55e"
                    strokeWidth="12"
                    strokeDasharray={`${(getAnsweredCount() / questions.length) * 502} 502`}
                    strokeDashoffset="0"
                    strokeLinecap="round"
            ...
            <div style={{ 
              ...
              <div style={{ 
                ...
                <span className="body-medium" style={{ fontWeight: '600' }}>
                  Answered & Submitted: <strong>{getAnsweredCount()}</strong>
                </span>
              </div>
              ...
              <div style={{ 
                ...
                <span className="body-medium" style={{ fontWeight: '600' }}>
                  Skipped: <strong>{getSkippedCount()}</strong>
                </span>
              </div>
            </div>
          </div>
          ...
          {/* Status of Questions */}
          <div style={{ marginBottom: '2rem' }}>
            <h3 className="heading-4" style={{ marginBottom: '1rem' }}>Status of Questions</h3>
              ...
              {questions.map((question, index) => (
                <button
                  ...
                  style={{
                    ...
                    borderRadius: '8px',
                    border: '2px solid',
                    backgroundColor: selectedAnswers[question.id] !== undefined ? '#22c55e' : '#e5e7eb',
                    borderColor: selectedAnswers[question.id] !== undefined ? '#16a34a' : '#d1d5db',
                    color: selectedAnswers[question.id] !== undefined ? 'white' : '#6b7280',
                    cursor: 'pointer',
                    fontSize: '1rem',
                    fontWeight: '600',
                    display: 'flex',
